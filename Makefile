...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog COPYING \
	...
	$(nobase_include_HEADERS) $(noinst_HEADERS) compile \
...
ACLOCAL = ${SHELL} /goinfre/install/myvw/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /goinfre/install/myvw/missing autoconf
AUTOHEADER = ${SHELL} /goinfre/install/myvw/missing autoheader
AUTOMAKE = ${SHELL} /goinfre/install/myvw/missing automake-1.14
AWK = gawk
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /goinfre/install/myvw/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = vowpal_wabbit 8.0.2
...
abs_builddir = /goinfre/install/myvw
abs_srcdir = /goinfre/install/myvw
abs_top_builddir = /goinfre/install/myvw
abs_top_srcdir = /goinfre/install/myvw
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /goinfre/install/myvw/install-sh
